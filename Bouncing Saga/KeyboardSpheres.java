...
class Sphere{
    ...
    public Sphere()
    {
        ...
        acceleration = new Pair(0.0, GRAVITY);
        radius = 25;
        dampening = 1.3;
    ...
    //methods to change gravity direction
    public void gravUp() {
        setAcceleration(new Pair(0, -GRAVITY));
    }
    ...
    public void gravLeft() {
        setAcceleration(new Pair(-GRAVITY, 0));
    }
...
public class KeyboardSpheres extends JPanel implements KeyListener{
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if(c == 'w') {
            for(int i = 0; i < this.world.spheres.length; i++) {
                this.world.spheres[i].gravUp();
            }
        } else if(c == 'a') {
            for(int i = 0; i < this.world.spheres.length; i++) {
                this.world.spheres[i].gravLeft();
            }
        } else if(c == 's') {
            for(int i = 0; i < this.world.spheres.length; i++) {
                this.world.spheres[i].gravDown();
            }
        } else if(c == 'd') {
            for(int i = 0; i < this.world.spheres.length; i++) {
                this.world.spheres[i].gravRight();
            }
        }
